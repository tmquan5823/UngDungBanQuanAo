...
namespace GUI
{
    public partial class UCThongTinCaNhan : UserControl
    {
        ...
        {
            if (userBLL.CheckNewAccount(account.AccountID))
            {
            ...
            else
            {
                ...
                UserInfo userInfo = userBLL.getByAccountId(account.AccountID);
                ...
                txt_tendangnhap.Text = account.UserAccount;
            }
        }
        ...
        private void btn_luu_Click(object sender, EventArgs e)
        {
            ...
            ui.AccountID = account.AccountID;
            ui.Address = txt_diachi.Text;
            if (userBLL.CheckNewAccount(account.AccountID))
            {
                groupBox1.Enabled = true;
